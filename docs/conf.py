# govuk-entity-personalisation documentation build configuration file
#
...
project = "govuk-entity-personalisation"
author = "alphagov"
...
htmlhelp_basename = "govuk-entity-personalisationdoc"
...
latex_documents = [
    ("index",
     "govuk-entity-personalisation.tex",
     u"govuk-entity-personalisation Documentation",
     u"alphagov", "manual"),
]
...
man_pages = [
    ("index", "govuk-entity-personalisation", u"govuk-entity-personalisation Documentation",
     [u"alphagov"], 1)
]
...
texinfo_documents = [
    ("index", "govuk-entity-personalisation", u"govuk-entity-personalisation Documentation",
     u"alphagov", "govuk-entity-personalisation",
     "Using entities on GOV.UK content to power personalisation", "Miscellaneous"),
]
